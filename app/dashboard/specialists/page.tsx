    ...
    return (
      <div className="flex-1 p-8">
        <div className="rounded-lg border border-destructive bg-destructive/10 p-4">
          <h3 className="text-lg font-medium text-destructive">Error Loading Specialists</h3>
      ...
      <div className="flex-1 p-8">
        <div className="rounded-lg border bg-card p-8">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-medium text-foreground">No Specialists Found</h3>
            <p className="text-sm text-muted-foreground mt-2 max-w-sm">
              You don't have any sleep specialists assigned to you yet. Please contact support if you need assistance.
            </p>
          </div>
        </div>
      </div>
